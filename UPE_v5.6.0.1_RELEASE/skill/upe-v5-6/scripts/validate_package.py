#!/usr/bin/env python3
"""Validate the complete UPE v5.6.0.1 release or extracted upe-v5-6 skill."""
...
SKILL_REQUIRED = [
    ...
    "references/UPE_v5.6.0.1_FULL_REFERENCE.md",
    "references/UPE_v5.6.0.1_PORTABLE_KERNEL.md",
    "references/UPE_v5.6.0.1_PROJECT_INSTRUCTIONS_KERNEL.md",
    "scripts/validate_package.py",
]

RELEASE_TO_SKILL_COPIES = {
    "01_UPE_v5.6.0.1_FULL_REFERENCE.md": "references/UPE_v5.6.0.1_FULL_REFERENCE.md",
    "02_UPE_v5.6.0.1_PROJECT_INSTRUCTIONS_KERNEL.md": (
        "references/UPE_v5.6.0.1_PROJECT_INSTRUCTIONS_KERNEL.md"
    ),
    "03_UPE_v5.6.0.1_PORTABLE_KERNEL.md": "references/UPE_v5.6.0.1_PORTABLE_KERNEL.md",
...
def main() -> int:
    ...
    errors: list[str] = []
    release_mode = (root / "01_UPE_v5.6.0.1_FULL_REFERENCE.md").is_file()
    ...
    kernel = (
        root / "02_UPE_v5.6.0.1_PROJECT_INSTRUCTIONS_KERNEL.md"
        if release_mode
        else root / "references/UPE_v5.6.0.1_PROJECT_INSTRUCTIONS_KERNEL.md"
    )
    portable = (
        root / "03_UPE_v5.6.0.1_PORTABLE_KERNEL.md"
        if release_mode
        else root / "references/UPE_v5.6.0.1_PORTABLE_KERNEL.md"
    )
    full_reference = (
        root / "01_UPE_v5.6.0.1_FULL_REFERENCE.md"
        if release_mode
        else root / "references/UPE_v5.6.0.1_FULL_REFERENCE.md"
    )
    worker = (
