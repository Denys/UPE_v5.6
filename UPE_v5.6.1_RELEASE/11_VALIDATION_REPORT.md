...
The qualifying fresh-context worker evaluated the first frozen v5.6.1 candidate:
...
| Check | Result |
|---|---:|
| Project kernel hard maximum `<8,000` characters | PASS: 7,779 |
| Portable kernel maximum `≤6,000` characters | PASS: 5,449 |
| Full reference present | PASS: 60,431 characters |
