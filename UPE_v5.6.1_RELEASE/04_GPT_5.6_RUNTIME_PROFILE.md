# UPE v5.6.1 — GPT-5.6 Runtime Profile
...
- current framework revision: v5.6.1;
- future releases on the same family: v5.6.3, v5.6.4, and so on;
...
v5.6.1 adds the terminal-audit core invariant CC-5.6.1-01 and includes its pre-publication packaging and calibration repairs. The version does not claim that every core rule was replaced.
