...
- [`UPE_v5.6.1_RELEASE/`](UPE_v5.6.1_RELEASE/) adds `CORE_CHANGE CC-5.6.1-01`: a terminal independent, read-only framework auditor/improver with quantified baseline, headroom, projected/empirical delta separation, complete revision, and version decision.
- [`validation/UPE-5.6.1-INDEPENDENT-AUDIT.md`](validation/UPE-5.6.1-INDEPENDENT-AUDIT.md) and [`validation/UPE-5.6.1-COORDINATOR-DISPOSITION.yaml`](validation/UPE-5.6.1-COORDINATOR-DISPOSITION.yaml) preserve the first execution of that gate.

Validate v5.6.1 with:
